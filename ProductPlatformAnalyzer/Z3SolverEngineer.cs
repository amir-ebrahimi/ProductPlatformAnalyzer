...
namespace ProductPlatformAnalyzer
{
    ...
    public class Z3SolverEngineer
    {
        ...
        /// <param name="pConvertVariantOperationRelations">If the Variantoperation mappings should be converted or not</param>
...
/*        public void ResetAnalyzer()
        ...
        /// According to the Variantgroup least for each Variantgroup a boolean expression is created.
        /// </summary>
            ...
            try
            {
                ...
                for (int i = 0; i < OperationList.Count-1; i++)
                {
                    for (int j = i+1; j < OperationList.Count; j++)
                    {
                            ...
                            //Action lAction1_CurrentTransition = null;
                            //Action lAction2_CurrentTransition = null;
                            //Action lAction1_NextTransition = null;
                            //Action lAction2_NextTransition = null;
                            ...
                            AnalysisResult = ActionDependencyAnalysis(dependencySolver
                                                                    , lCurrentOperation1Instance.Action_I2E
                                                                    , lCurrentOperation2Instance.Action_I2E);
                            #region PreviousVersion
                            //lAction1_CurrentTransition = lCurrentOperation1Instance.Action_I2E;
                            //lAction2_CurrentTransition = lCurrentOperation2Instance.Action_I2E;

                            //lAction1_NextTransition = lNextOperation1Instance.Action_I2E;
                            //lAction2_NextTransition = lNextOperation2Instance.Action_I2E;

                            //lActionDependencyTracking += "Action1: " + lAction1_CurrentTransition.Name + ", ";
                            //lActionDependencyTracking += "Action2: " + lAction2_CurrentTransition.Name + Environment.NewLine;
                            //lActionDependencyTracking += "Action1 Precondition: " + ReturnPreconditionsAsString(lAction1_CurrentTransition.Precondition) + Environment.NewLine;
                            //lActionDependencyTracking += "Action2 Precondition: " + ReturnPreconditionsAsString(lAction2_CurrentTransition.Precondition) + Environment.NewLine;
                            //lActionDependencyTracking += "Action2 Effect: " + lAction2_CurrentTransition.Effect + " -> ";
                            ...
                            //                                                , lAction1_CurrentTransition
                            //                                                , lAction2_CurrentTransition
                            //                                                //, lAction1_New
                            //                                                //, lAction2_New
                            //                                                );
                            ...
                            //    DependentActionsList.Add(new DependentActions(lAction1_CurrentTransition, lAction2_CurrentTransition));

                            //_z3Solver.WriteDebugFile("0", 0, lAction1_CurrentTransition.Name + "-" + lAction2_CurrentTransition.Name + "-Dependency");
                            #endregion

                            //Case 2: Operation1.ActionI2E vs Operation2.ActionE2F
                            AnalysisResult = ActionDependencyAnalysis(dependencySolver
                                                                    , lCurrentOperation1Instance.Action_I2E
                                                                    , lCurrentOperation2Instance.Action_E2F);

                            #region PreviousVersion
                            //lAction1_CurrentTransition = lCurrentOperation1Instance.Action_I2E;
                            //lAction2_CurrentTransition = lCurrentOperation2Instance.Action_E2F;

                            //lAction1_NextTransition = lNextOperation1Instance.Action_I2E;
                            //lAction2_NextTransition = lNextOperation2Instance.Action_I2E;

                            //lActionDependencyTracking += "Action1: " + lAction1_CurrentTransition.Name + ", ";
                            //lActionDependencyTracking += "Action2: " + lAction2_CurrentTransition.Name + " -> ";
                            //lActionDependencyTracking += "Action1 Precondition: " + ReturnPreconditionsAsString(lAction1_CurrentTransition.Precondition) + Environment.NewLine;
                            //lActionDependencyTracking += "Action2 Precondition: " + ReturnPreconditionsAsString(lAction2_CurrentTransition.Precondition) + Environment.NewLine;
                            //lActionDependencyTracking += "Action2 Effect: " + lAction2_CurrentTransition.Effect + " -> ";
                            ...
                            AnalysisResult = ActionDependencyAnalysis(dependencySolver
                                                                    , lCurrentOperation1Instance.Action_E2F
                                                                    , lCurrentOperation2Instance.Action_I2E);

                            #region PreviousVersion
                            //lAction1_CurrentTransition = lCurrentOperation1Instance.Action_E2F;
                            //lAction2_CurrentTransition = lCurrentOperation2Instance.Action_I2E;
        ...
        private bool ActionDependencyAnalysis(Z3Solver pDependencySolver, Action pAction1, Action pAction2)
        {
            try
            {
                bool AnalysisResult = false;
                ...
                Action lAction1_NextTransition = pAction1.NextMyTypeAction();
                Action lAction2_NextTransition = pAction1.NextMyTypeAction();

                lActionDependencyTracking += "Action1: " + pAction1.Name + ", ";
                lActionDependencyTracking += "Action2: " + pAction2.Name + Environment.NewLine;
                lActionDependencyTracking += "Action1 Precondition: " + ReturnPreconditionsAsString(pAction1.Precondition) + Environment.NewLine;
                lActionDependencyTracking += "Action2 Precondition: " + ReturnPreconditionsAsString(pAction2.Precondition) + Environment.NewLine;
                lActionDependencyTracking += "Action2 Effect: " + pAction2.Effect + " -> ";

                lTempActionsDependency = Check2ActionsDependency(pDependencySolver
                                                                //, lCurrentOperation1Instance
                                                                //, lCurrentOperation2Instance
                                                                //, lNextOperation1Instance
                                                                //, lNextOperation2Instance
                ...
                if (AnalysisResult)
                    //This means the two analyzed actions are dependent hence they should not happen at the same time
                    DependentActionsList.Add(new DependentActions(pAction1, pAction2));

                _z3Solver.WriteDebugFile("0", 0, pAction1.Name + "-" + pAction2.Name + "-Dependency");
                                            ...
                                            )
        {
            ...
            try
            {
               ...
               var lZ3Solver2 = new Z3Solver(_outputHandler);
                ...
                BoolExpr lAction2Pre_CurrentTransitionVariable = _z3Solver.AddBooleanExpression("Action2Pre_K"); //Formula first Part name
                BoolExpr lAction2Pre_NextTransitionVariable = _z3Solver.AddBooleanExpression("Action2Pre_K+1");
                ...
                CarryOutNeededActionsOnPrecondition(lAction2Pre_CurrentTransitionVariable
                                                    , pAction2_CurrentTransition
                                                    , lAction2Pre_NextTransitionVariable
                ...
                BoolExpr lAction1Eff_NextTransitionVariable = _z3Solver.AddBooleanExpression("Action1Eff_K+1");
                BoolExpr lAction2Eff_NextTransitionVariable = _z3Solver.AddBooleanExpression("Action2Eff_K+1");
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction1_CurrentTransition.MyOperationInstance.InitialVariableName
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction1_CurrentTransition.MyOperationInstance.ExecutingVariableName
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction1_CurrentTransition.MyOperationInstance.FinishedVariableName
                ...
                BoolExpr lPickOne4Action1_CurrentTransition = _z3Solver.PickOneOperator(new List<string> { pAction1_CurrentTransition.MyOperationInstance.InitialVariableName
                ...
                BoolExpr lPickOne4Action1_NextTransition = _z3Solver.PickOneOperator(new List<string> { pAction1_CurrentTransition.NextMyTypeAction().MyOperationInstance.InitialVariableName
                                                                                , pAction1_CurrentTransition.NextMyTypeAction().MyOperationInstance.ExecutingVariableName
                                                                                , pAction1_CurrentTransition.NextMyTypeAction().MyOperationInstance.FinishedVariableName
                                                                                , pAction1_CurrentTransition.NextMyTypeAction().MyOperationInstance.UnusedVariableName });
                _z3Solver.AddConstraintToSolver(lPickOne4Action1_CurrentTransition, "PickOne1_K");
                _z3Solver.AddConstraintToSolver(lPickOne4Action1_NextTransition, "PickOne1_K+1");
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction2_CurrentTransition.MyOperationInstance.InitialVariableName
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction2_CurrentTransition.MyOperationInstance.ExecutingVariableName
                ...
                AddingActionsCurrentNNextTransitionVariables(pAction2_CurrentTransition.MyOperationInstance.FinishedVariableName
                ...
                BoolExpr lPickOne4Action2_CurrentTransition = _z3Solver.PickOneOperator(new List<string> { pAction2_CurrentTransition.MyOperationInstance.InitialVariableName
                ...
                BoolExpr lPickOne4Action2_NextTransition = _z3Solver.PickOneOperator(new List<string> { pAction2_CurrentTransition.NextMyTypeAction().MyOperationInstance.InitialVariableName
                                                                                , pAction2_CurrentTransition.NextMyTypeAction().MyOperationInstance.ExecutingVariableName
                                                                                , pAction2_CurrentTransition.NextMyTypeAction().MyOperationInstance.FinishedVariableName
                                                                                , pAction2_CurrentTransition.NextMyTypeAction().MyOperationInstance.UnusedVariableName });
                _z3Solver.AddConstraintToSolver(lPickOne4Action2_CurrentTransition, "PickOne2_K");
                _z3Solver.AddConstraintToSolver(lPickOne4Action2_NextTransition, "PickOne2_K+1");
                //}
                ...
                string lAction1Eff_NextTransitionVariableName = ReplaceStringVariables(pAction1_CurrentTransition.Effect
                                                                    , CurrentNNextTransitionVariableNames);
                lAction1Eff_NextTransitionVariable = ConvertComplexString2BoolExpr(lAction1Eff_NextTransitionVariableName);

                string lAction2Eff_NextTransitionVariableName = ReplaceStringVariables(pAction2_CurrentTransition.Effect
                                                                    , CurrentNNextTransitionVariableNames);
                lAction2Eff_NextTransitionVariable = ConvertComplexString2BoolExpr(lAction2Eff_NextTransitionVariableName);
                ...
                BoolExpr lRightHandSide1 = _z3Solver.AndOperator(new List<BoolExpr>(){ lAction1Pre_CurrentTransitionVariable
                                                                                        ...
                                                                                        , lAction2Pre_CurrentTransitionVariable
                                                                                        , lAction2Eff_NextTransitionVariable
                                                                                        , lOtherVarSame1});

                BoolExpr lRightHandSide2 = _z3Solver.AndOperator(new List<BoolExpr>(){ lAction2Pre_CurrentTransitionVariable
                                                                                        , _z3Solver.NotOperator(lAction2Pre_NextTransitionVariable)
                                                                                        , lAction1Pre_CurrentTransitionVariable
                                                                                        , lAction1Eff_NextTransitionVariable
                                                                                        , lOtherVarSame2});
        ...
        private void AddingActionsCurrentNNextTransitionVariables(string pCurrentTransitionVariableName
                            ...
                            if (pSatResult.Equals(Status.SATISFIABLE))
                            {
                                if (pExtraField != null)
                                {
                                    ...
                                    if (ReportAnalysisResult)
                                    {
                                        ...
                                        //Analysis Result
                                        //if it does hold, then there is a configuration which is valid and this current Variantis not present in it
                    ...
                    case Enumerations.AnalysisType.OperationSelectabilityAnalysis:
                        {
                            ...
                            {
                                //Here we check if this operation is in active operation or not, meaning does a Variantuse this operation for its assembly or not
        ...
        public void ConvertItemUsageRulesConstraints(bool pOptmizer = false)
        {
            try
            {
                ...
                foreach (PartUsageRule lPartUsageRule in _frameworkWrapper.PartUsageRuleSet)
                {
                    ...
                    BoolExpr lRightHandSide = (BoolExpr)_z3Solver.FindExprInExprSet(lPartUsageRule.Part.Names);

                    BoolExpr lLeftHandSide = ConvertComplexString2BoolExpr(lPartUsageRule.VariantExpression);
        ...
        /// <summary>
        /// This function converts the configuration rules, i.e. Variantgroup cardinality and constraint rules
        /// </summary>
        ...
        private void ConvertFResource2Z3Constraints(bool pOptimizer = false)
        {
            try
            {
                ...
                {
                    string lResourceName = lResource.Name;
...
//                    List<string> lPossibleResourceVariablesForActiveOperation = new List<string>();
                    ...
                    foreach (Resource lActiveResource in _frameworkWrapper.ResourceSet)
                    {
                        ...
                        string lPossibleToUseResource4OperationName = "Possible_to_use_" + lActiveResource.Name + "_for_" + lActiveOperation.Name;
...
//                        lPossibleResourceVariablesForActiveOperation.Add(lPossibleToUseResource4OperationName);
                        ...
                        string lUseResource4OperationName = "Use_" + lActiveResource.Name + "_for_" + lActiveOperation.Name;
        ...
        //TODO: is it needed?
        /*private VariantReturnCurrentVariant(string pVariantExpression)
        {
            ...
            try
            {
                ...
                {
                    //If the Variantexpression does contain any spaces other than the start or ending space then it is an expression

                    //A new Virtual Variantneed to be build

                    //The virtual Variantneeds to be added to virtual Variantgroup
                ...
                {
                    //If the Variantexpression does NOT contain any spaces other than the start or ending space then it is a variant
            ...
            try
            {
                ...
                if (lResourceList.Count >0)
                {
                    ...
                    foreach (var lResource in lResourceList)
                    {
                        ...
                        _resourcesOperations.Add(lResource.Name, lOperations);
                    }
...
/*
  ...
  */
        ...
        /// <param name="pPartIndex">The Variantwhich will be assigned to this operation instance variables</param>
...
//                lFrameworkWrapper.addOperationInstance(lOperationPostConditionName);
        ...
        /// </summary>
        /// <param name="pOperationName">The operation for which the instance variables will be defined</param>
        /// <param name="pVariantIndex">The Variantwhich will be assigned to this operation instance variables</param>
        /// <param name="pState">The transitionNo which will be assigned to this operation instance variable</param>
        ...
        //This function is removed in the new version when operation instances have become a seperate object
        /*public void resetCurrentStateAndNewStateOperationVariables(operation pOperation, VariantpVariant, int pState, string pConstraintSource)
        {
            try
            {
        ...
        //This function is removed in the new version when operation instances have become a seperate object
        /*public void resetCurrentStateOperationVariables(operation pOperation, VariantpVariant, int pState)
        {
            try
            {
                int lVariantIndex = cFrameworkWrapper.indexLookupByVariant(pVariant);
        ...
        {
            //Loop over Variantlist
            //For each Variantfind the Variantin variant-operation mapping table
...
//                            lZ3Solver.AddImpliesOperator2Constraints(tempLeftHandSide, tempRightHandSide);
            ...
            //formula 6
            //In the list of operations, start with operations indexed for Variant0 and compare them with all operations indexed with one more
        ...
        /*public void resetOperationPrecondition(operation pOperation, VariantpVariant, int pState, string pConstraintSource)
        {
            try
            {
        ...
        //In the new version, after we created the trigger field of the operation hence removing Variantoperation mapping, there is no more need for this function
        /*/// <summary>
        ...
        /// <summary>
        /// This function checks if an operation instance has the VariantPart missing
        /// </summary>
        /// <param name="pOperationInstance"></param>
        /// <returns></returns>
        ...
        /*public void resetOperationPostcondition(operation pOperation, VariantpVariant, int pState, String pPostconditionSource)
        {
            try
            {
                int lVariantIndex = cFrameworkWrapper.indexLookupByVariant(pVariant);
            ...
            try
            {
                ...
                if (pCon.Contains('_'))
                {
                    ...
                    if (lOperationNameParts.Length != 3)
                    {
                        ...
                        {
                            //This means the precondition does not include a Variantnor a state
                            ...
                            foreach (string Variantin vInstances)
                            {
                        ...
                        {
                            //This means the precondition does includes a Variantbut not a state
        ...
        /*private Part returnCurrentVariant(partOperations pVariantOperations)
        {
            ...
            try
            {
                ...
                {
                    //The result Variantis going to be a virtual Varianthence for this Variantwe have to add the needed operations
...
/*                    && (pNode.Data != "<")
                    ...
                    )
                {
                    //We have one operator
                    ////lResult = pNode.Data;
                    //This operand can be an operation or it can be a Variantor it can be a part, if it is an operation then it has to be checked if it is in a complete operation instance format or not
...
/*        public BoolExpr returnBoolExprOfConstraint(string pConstraint)
        ...
        public BoolExpr createFormula7(List<variant> pVariantList, int pState)
        {
            ...
            foreach (VariantlVariant in pVariantList)
            {
                variantOperations lVariantOperations = lFrameworkWrapper.getVariantOperations(lVariant.names);
                if (lVariantOperations != null)
                {
                    ...
                    if (lOperationList != null)
                    {
                        foreach (operation lOperation in lOperationList)
                        {
                            ...
                            //                if (lOperationNameParts.Length == 2)
                            //                    //This means the postcondition does not include a Variantnor a state
                            //                    //Needs to be properly implementet
                            //                    lOpPostcondition = lZ3Solver.FindBoolExpressionUsingName(lOperation.postcondition[0] + currentVariant.index + "_" + pState.ToString());
                            //                else
                            //                    //This means the postcondition does includes a Variantbut not a state
...
/*        public BoolExpr createFormula7(HashSet<part> pPartList, int pState)
            ...
            try
            {
                ...
                if (lModelConstraintCheck.Equals(Status.SATISFIABLE))
                {
                    for (int lTransitionNo = 0; lTransitionNo <= _maxNumberOfTransitions; lTransitionNo++)
                    {
                        ...
                        //For each Variantcheck if this statement holds - carry out the analysis
                                                    ...
                                                    , bool pReportTypeSet)
        {
            ...
            try
            {
                ...
                //        this check is done for each seperate Variantfrom the Variantgroup
            ...
            try
            {
                ...
                if (lModelConstraintCheck.Equals(Status.SATISFIABLE))
                {
                    ...
                    foreach (Variant lCurrentVariant in lVariantList)
                    {
                        ...
                        {
                            //If the result of the first analysis was false that means the selected Variantis in conflict with the rest of the product platform
                                                    ...
                                                    , bool pReportTypeSet)
        {
            ...
            try
            {
                ...
                _outputHandler.PrintMessageToConsole("Never selected VariantAnalysis:");
                ...
                if (lVariantList.Count > 0)
                {
                    ...
                    //V_i
                    //SAT:  There is a configuration where this Variantis selected
                    //UNSAT: This Variantis never selected
                                                    ...
                                                    , bool pReportTypeSet)
        {
            ...
            try
            {
                ...
                _outputHandler.PrintMessageToConsole("Always selected VariantAnalysis:");
                ...
                if (lVariantList.Count > 0)
                {
                    ...
                    //!V_i
                    //SAT: There is a configuration where this Variantis NOT selected
        ...
        /// <summary>
        /// This function will give us a boolean expression of all the operation instances of a specific operation on a specific Variantand a specific operation state
        ...
        private BoolExpr OperationInstanceFinishedStateInAllTransitions(OperationInstance pOperationInstance, int pSpecificTransitionNo = -1)
        {
            ...
            try
            {
                ...
                //for operation instances related to this Variantin all of the transitions
        ...
        /// <param name="pSpecificTransitionNo">In we need the expression for one transition</param>
        /// <returns></returns>
        private BoolExpr OperationInAllTransitions(operation pOperation, VariantpVariant, string pOperationState, int pSpecificTransitionNo = -1)
        {
            BoolExpr lResultExpr = null;
            try
            {
        ...
        /// These any variants and in any transitions can be fixed to one specific Variantand one specific transition if their respective parameters are set
                                                                ...
                                                                , int pSpecificTransition = -1)
        {
            ...
            try
            {
                ...
                {
                    foreach (VariantlCurrentVariant in cFrameworkWrapper.VariantSet)
                    {
        ...
        private string ReturnPartNamesFromList(List<Part> pPartList)
        {
            ...
            try
            {
                ...
                foreach (Part lPart in pPartList)
                {
                    ...
                    //Add the name of the Variantto the list
        ...
        private string ReturnVariantNamesFromList(List<Variant> pVariantList)
        {
            ...
            try
            {
                ...
                {
                    //if the Variantlist is previously filled with something then add a comma before adding the next item
                    if (lVariantNames != "")
                        lVariantNames += " ,";
        ...
        private string ReturnOperationNamesFromList(List<Operation> pOperationList)
        {
            ...
            try
            {
                ...
                foreach (Operation lOperation in pOperationList)
                {
                    ...
                    lOperationNames += lOperation.Name;
                }
            }
            catch (Exception ex)
            {
...
/*                if (cFrameworkWrapper.UsePartInfo)
                ...
                else
                {
                    foreach (var lVariant in cFrameworkWrapper.VariantSet)
                    {
                        ...
                        foreach (var lCurrentOperation in lOperationSet)
                        {
                            ...
                            foreach (var lCurrentTransitionOperationInstance in pCurrentTransitionOperationInstanceList)
                            {
                                VariantlTempVariant = cFrameworkWrapper.ReturnOperationVariantFromOperationInstance(lCurrentTransitionOperationInstance);
        ...
        //At that time Part to operation mapping and Variantto operation mapping existed
        //TODO: If the analysis passed all tests these parts should be removed
        /*public VariantParseVariantExpr(string pVariantExpr)
        {
        ...
        public void InitializeDataFiles()
        {
            try
            {
                ...
                //Item usadge rules
                _frameworkWrapper.PartUsageRuleSet.Clear();
